        ...
        <div className="">
            <div className="flex flex-col items-center justify-around mt-4">
                ...
                <div className="lg:flex lg:justify-between lg:items-center mt-12 w-full text-base mx-2 lg:mx-16">
                    ...
                    <div className="mt-1">
                        <button className="px-6 py-2 bg-blue-500 rounded shadow text-white font-bold" onClick={handleAddItem}>
                            {/* <i className="ri-add-line font-bold"></i> Add */}
            ...
            <div className="flex items-center mt-10 text-white">
                <div className={`font-bold w-16 text-center px-2 py-1 shadow-md ${show === 0 ? 'bg-green-600' : 'bg-gray-700'}`} onClick={() => setShow(0)}>To Do</div>
                <div className={`font-bold w-28 text-center px-3 py-1 shadow-md ${show === 1 ? 'bg-green-600' : 'bg-gray-700'}`} onClick={() => setShow(1)}>Completed</div>
            </div>

            <div className="">
                {
                    (show === 0) ? <ShowTasks items={items} setItems={setItems} completed={completed} setCompleted={setCompleted} /> : <ShowCompletedTasks completed={completed} setCompleted={setCompleted} />
                }
            </div>
        </div>
    );
